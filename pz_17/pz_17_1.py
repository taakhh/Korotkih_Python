...
tk.Radiobutton(deg_f, text="Pursuing", variable=tk.IntVar(), value=1, bg="#336699", fg="white").grid(row=0, column=1, padx=10)
tk.Radiobutton(deg_f, text="Completed", variable=tk.IntVar(), value=2, bg="#336699", fg="white").grid(row=0, column=2)

tk.Label(frame, text="Avarage CPI :", bg="#336699", fg="white", font=label_font).grid(row=4, column=0, sticky="e", padx=10, pady=5)
cpi_f = tk.Frame(frame, bg="#336699")
cpi_f.grid(row=4, column=1, sticky="w")
tk.Entry(cpi_f, width=6).grid(row=0, column=0)
